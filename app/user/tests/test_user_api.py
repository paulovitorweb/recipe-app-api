...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_for_user(self):
        ...
        payload = {'email': 'user@mail.com', 'password': 'test123'}
        create_user(name='Test', **payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(name='Test', email='test@test.com', password='testpass')
...
class PrivateUserApiTests(TestCase):
    ...
    def test_post_me_not_allowed(self):
        """Test that POST is not alloweb on the url"""
        res = self.client.post(ME_URL, {})

        self.assertEqual(res.status_code, status.HTTP_405_METHOD_NOT_ALLOWED)

    def test_update_user_profile(self):
        """Test updating the user profile for authenticaed user"""
